...
/* LGE_CHANGE_S, [yoohoo@lge.com], 2009-9-9, <Del selected AP from blacklist to remove a user confusion> */
#ifdef WPA_SUPPLICANT_PATCH
	wpa_blacklist_clear(wpa_s);
#endif
/* LGE_CHANGE_E, [yoohoo@lge.com], 2009-9-9, <Del selected AP from blacklist to remove a user confusion> */
...
/* LGE_CHANGE_S, [jisung.yang@lge.com], 2010-07-28, <Do not do unnecessary scan> */	
/* If scan here, it trigger associate to another AP even though connected to an AP */
#ifdef WPA_SUPPLICANT_PATCH	
			if (os_strncmp(buf+10, "clear", 5) == 0 &&
#else
			if (os_strncmp(buf+10, "clear", 5) == 0 ||
#endif				
/* LGE_CHANGE_E, [jisung.yang@lge.com], 2010-07-28, <Do not do unnecessary scan> */	
...
#endif	
/* LGE_CHANGEE [jisung.yang@lge.com], 2010-07-04, <Do broadcast scan after specific> */
				wpa_supplicant_req_scan(wpa_s, 0, 0);
			}
		}
#endif
