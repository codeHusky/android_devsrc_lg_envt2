...
void eapol_sm_port_timer_trigger(struct eapol_sm *sm){
	if (eloop_is_timeout_registered(eapol_port_timers_tick, NULL, sm))
		return;
	eloop_register_timeout(0, 0, eapol_port_timers_tick, NULL, sm);
	return;
}
